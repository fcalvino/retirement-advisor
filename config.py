...
# Six scenarios, calibrated from Bloomberg / FRED historical data (S27 — moved
# here from portfolio/stress_test.py so a methodology change is a config edit;
# stress_test.py re-exports this as SCENARIOS for existing callers/tests).
STRESS_SCENARIOS: List[StressScenario] = [
    ...
    StressScenario(
        ...
        sector_shocks={
            ...
            "ETF":                  -19.0,
            "Crypto":               -70.0,    # BTC/ETH 2022 peak-to-trough
            "Crypto / Digital Asset": -70.0,
        },
        default_shock=-18.0,
        duration_months=12,
